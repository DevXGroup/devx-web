...
const createDirectories = () => {
  const dirs = ['./public/images/portfolio', './public/images/portfolio/banners', './public/images/portfolio/previews'];
  dirs.forEach(dir => {
...
const downloadAllImages = async () => {
  ...
  // Save updated data
  fs.writeFileSync('./helper/projects-with-local-images.json', JSON.stringify(updatedProjectsData, null, 2));
  ...
  for (const project of projectsData.projects) {
    ...
    try {
      ...
      if (bannerResponse.ok) {
        ...
        fs.writeFileSync(`./public/images/portfolio/banners/${projectName}-banner.webp`, Buffer.from(bannerBuffer));
      ...
      if (previewResponse.ok) {
        ...
        fs.writeFileSync(`./public/images/portfolio/previews/${projectName}-preview.webp`, Buffer.from(previewBuffer));
