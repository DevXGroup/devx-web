...
export const getOptimizedTransition = (type: keyof typeof OPTIMIZED_TRANSITIONS = 'standard', isLowPower?: boolean) => {
  const transition = (type in OPTIMIZED_TRANSITIONS ? OPTIMIZED_TRANSITIONS[type] : OPTIMIZED_TRANSITIONS.standard) as Transition;
