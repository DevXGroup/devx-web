...
const pricingPlans = [
  {
    ...
    priceUnit: "/hour",
    originalPrice: "$95",
    description: "Ideal for startups and small businesses looking to build their first digital solution",
    icon: Target,
    popular: false,
    color: "#4CD787",
  ...
  },
  {
    ...
    priceUnit: "/hour",
    originalPrice: "$125",
    description: "Perfect for growing businesses that need comprehensive solutions and dedicated support",
    icon: Zap,
    popular: true,
    color: "#CFB53B",
  ...
  },
  {
    ...
    priceUnit: "/hour",
    originalPrice: "$160",
    description: "For large organizations requiring enterprise-grade solutions with premium support",
    icon: Crown,
    popular: false,
    color: "#9d4edd",
...
function PricingCard({ plan, index, isYearly }) {
  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 ${plan.popular ? 'pt-12 px-6 pb-6' : 'p-6'} h-full flex flex-col`}>
        {/* Header section */}
        ...
        <div className="mb-4 flex-grow">
          ...
          <ul className="space-y-2">
            {plan.features.slice(0, 5).map((feature, featureIndex) => (
              ...
              >
                <Check className="w-3 h-3 mr-2 mt-0.5 flex-shrink-0" style={{ color: plan.color }} />
                {feature}
              </motion.li>
            ))}
        ...
        <div className="mb-6">
          <h4 className="text-xs font-bold mb-3 uppercase tracking-wider flex items-center gap-2" style={{ color: plan.color }}>
          ...
          >
            {plan.included.slice(0, 3).map((item, itemIndex) => (
              ...
              >
                <span className="w-1 h-1 rounded-full mr-2 mt-1.5 flex-shrink-0" style={{ backgroundColor: plan.color }} />
                {item}
              </motion.li>
            ))}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-[#4CD787] font-medium"> Choose the perfect plan</span> for your project needs.
            </motion.p>
          ...
          >
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
                Need Something 
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4CD787] to-[#CFB53B]"> Custom</span>?
              </h2>
