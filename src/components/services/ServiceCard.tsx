...
export default function ServiceCard({ service, index }: ServiceCardProps) {
  ...
  return (
    <div
      ref={ref}
      className="bg-black/30 backdrop-blur-sm p-8 rounded-xl border border-white/10 group hover:border-white/30 transition-all duration-300 relative overflow-hidden h-full flex flex-col"
