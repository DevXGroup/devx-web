...
function WhyUsCard({
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className="group relative bg-gradient-to-br from-slate-800 to-slate-900 backdrop-blur-sm p-8 rounded-2xl border border-indigo-500/20 flex flex-col items-center text-center overflow-hidden cursor-pointer transition-all duration-300 min-h-[280px] sm:min-h-[300px] w-full max-w-full shadow-xl group-hover:shadow-[0_0_20px_rgba(99,102,241,0.5)] before:absolute before:inset-0 before:border before:border-transparent before:rounded-2xl before:transition-all before:duration-300 group-hover:before:border-indigo-400/40"
    >
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center h-full">
        {/* Icon */}
        <motion.div
          className="w-16 h-16 rounded-full flex items-center justify-center mb-6 relative overflow-hidden aspect-square shrink-0 bg-gradient-to-br from-indigo-500 to-purple-600"
          whileHover={{
        ...
        >
          ...
          >
            <Icon className="w-8 h-8 transition-all duration-300 relative z-10 text-white pointer-events-none" />
          </motion.div>
        </motion.div>

        {/* Title */}
        <motion.h3
          className="text-base sm:text-lg md:text-xl font-bold font-['IBM_Plex_Mono'] text-indigo-400 group-hover:text-indigo-300 transition-colors duration-300 mb-4 break-words text-center px-2"
          whileHover={{
            scale: 1.05,
        ...
        {/* Description */}
        <motion.p
          className="text-slate-300 font-['IBM_Plex_Sans'] text-base sm:text-lg leading-relaxed group-hover:text-white transition-colors duration-500 text-center max-w-full break-words px-2"
...
export default function Features() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative pt-32 md:pt-40 pb-16 md:pb-20 overflow-hidden bg-slate-900 w-full"
    >
      ...
      >
        ...
        <div ref={hireDevelopersRef} className="relative">
          {/* Hero Section */}
          <div className="text-center mb-12 md:mb-16 relative z-[3]">
            {/* Fixed title visibility with inline styles */}
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 font-['IBM_Plex_Mono'] text-white pb-3">
          ...
          <motion.div
            className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-16 md:mb-20 max-w-5xl mx-auto px-4 sm:px-6 relative z-[3]"
            variants={containerVariants}
          >
            <motion.div
              variants={fadeIn}
            ...
            >
              ...
              <div className="relative flex flex-col gap-6">
                <motion.div
                  className="flex-shrink-0 w-12 h-12 md:w-14 md:h-14 rounded-full bg-[#ccff00] flex items-center justify-center"
                  whileHover={shouldReduceMotion ? {} : { scale: 1.05 }}
                  transition={{ duration: 0.3 }}
                >
                  <Rocket className="w-6 h-6 md:w-7 md:h-7 text-black" />
                </motion.div>

                <div className="flex-1">
                  <h3 className="text-xl md:text-2xl font-bold text-white font-['IBM_Plex_Sans'] mb-3 leading-tight">
        ...
        <div className="relative -mx-4 px-4 py-12 md:py-16 my-12 md:my-16 bg-transparent">
          <div className="relative z-10 text-center">
            <div className="flex items-baseline justify-center">
              <span className="text-2xl sm:text-4xl md:text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-purple-500 mr-3">
                Creative
              </span>
              <RotatingText
                texts={subheaders}
                ...
                staggerFrom="center"
                mainClassName="relative -top-0.5 font-bold text-lg sm:text-2xl md:text-3xl font-mono"
        ...
        <div className="relative -mx-4 px-4 py-4 md:py-4 mt-16 md:mt-20 mb-20 md:mb-24 bg-transparent">
          {/* Steps Container */}
          <div className="relative bg-gradient-to-br from-gray-900 to-black backdrop-blur-md py-12 px-6 md:px-12 rounded-2xl border border-slate-600/50 shadow-lg max-w-4xl mx-auto">
            {/* Steps Grid */}
        ...
        <div id="why-devx-section" className="text-center mb-16 md:mb-20">
          ...
          <div className="max-w-3xl mx-auto mb-16">
            <p className="text-slate-300 text-lg md:text-xl mb-4 font-['IBM_Plex_Mono']">
        ...
        <div className="text-center mb-16">
          <p className="text-[#ccff00] text-2xl md:text-3xl font-bold mb-4 font-['IBM_Plex_Mono']">
            We&apos;re ready to transform your vision into reality.
          </p>
          <p className="text-slate-300 text-xl md:text-2xl font-['IBM_Plex_Mono']">
