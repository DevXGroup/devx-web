    ...
    <div className="sm-scope w-full h-full">
      ...
      >
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full bg-black flex flex-col p-[6em_2em_4em_2em] sm:p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px]"
...
@media (max-width: 640px) { .sm-scope .staggered-menu-panel { width: 100%; left: 0; right: 0; } .sm-scope .sm-panel-item { font-size: clamp(2rem, 11vw, 3rem); letter-spacing: -0.8px; padding-right: 1.2em; } .sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { display: none; } .sm-scope .staggered-menu-wrapper[data-open] .sm-logo-img { filter: invert(100%); } }
      `}</style>
    </div>
  )
}
