...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  position = 'right',
  colors = ['#ff6b6b', '#4ecdc4', '#45b7d1', '#96ceb4', '#ffeaa7', '#a8e6cf', '#ff8b94', '#b4a7d6'],
  items = [],
  socialItems = [],
  displaySocials = true,
  ...
  }, [externalIsOpen, playOpen, playClose, animateIcon, animateColor, animateText])
        ...
        >
          {(() => {
            ...
            return arr.map((c, i) => (
              <div
                key={i}
                className="sm-prelayer absolute top-0 right-0 h-full will-change-transform"
                style={{
                  background: c,
                  opacity: 1.0,
                  width: `${100 - i * 8}%`, // Each layer more distinctly narrower: 100%, 92%, 84%, 76%
                  zIndex: arr.length - i,
                  borderRadius: '0px',
                  backfaceVisibility: 'hidden',
                  WebkitBackfaceVisibility: 'hidden',
...
.sm-scope .sm-panel-itemWrap { position: relative; overflow: hidden; line-height: 1; width: 100%; }
...
.sm-scope .sm-prelayer { position: absolute; top: 0; right: 0; height: 100%; width: 100%; transform: translateX(0); will-change: transform; backface-visibility: hidden; -webkit-backface-visibility: hidden; }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid #4CD787; outline-offset: 3px; }
...
.sm-scope .sm-panel-item { position: relative; color: #fff; font-weight: 600; font-size: clamp(2.4rem, 9vw, 4rem); cursor: pointer; line-height: 1; letter-spacing: -1px; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 1.1em; word-break: break-word; overflow-wrap: anywhere; max-width: 100%; }
.sm-scope .sm-panel-itemLabel { display: inline-block; will-change: transform; transform-origin: 50% 100%; }
.sm-scope .sm-panel-item:hover { color: var(--item-hover-color, var(--sm-accent, #ff0000)); }
.sm-scope .sm-panel-list[data-numbering] { counter-reset: smItem; }
.sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { counter-increment: smItem; content: counter(smItem, decimal-leading-zero); position: absolute; top: 0.1em; right: 3.2em; font-size: 18px; font-weight: 400; color: var(--sm-accent, #ff0000); letter-spacing: 0; pointer-events: none; user-select: none; opacity: var(--sm-num-opacity, 0); }
@media (max-width: 1024px) { .sm-scope .staggered-menu-panel { width: 100%; left: 0; right: 0; } .sm-scope .staggered-menu-wrapper[data-open] .sm-logo-img { filter: invert(100%); } }
@media (max-width: 640px) { .sm-scope .staggered-menu-panel { width: 100%; left: 0; right: 0; padding: 5em 1.5em 1.5em 1.5em; } .sm-scope .sm-panel-list { gap: 0.4rem; } .sm-scope .sm-panel-item { font-size: clamp(2.2rem, 12vw, 3.3rem); letter-spacing: -0.9px; padding-right: 0.85em; line-height: 1.02; } .sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { right: 0.5em; top: -0.05em; font-size: 0.95rem; } .sm-scope .staggered-menu-wrapper[data-open] .sm-logo-img { filter: invert(100%); } }
@media (max-width: 480px) { .sm-scope .staggered-menu-panel { padding: 4.5em 1.25em 1.25em 1.25em; } .sm-scope .sm-panel-item { font-size: clamp(1.9rem, 14vw, 3rem); letter-spacing: -0.8px; } .sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { right: 0.35em; top: -0.15em; } }
      `}</style>
    </div>
  )
}
