              ...
              <div className="flex flex-col gap-3 items-end">
                ...
                <div className="flex flex-col gap-2 items-end">
                  ...
                  <div className="flex items-center gap-2 flex-wrap justify-end">
                    ...
                    {/* Web */}
                    {(project.platforms.some(p => p.toLowerCase().includes('web') || p.toLowerCase().includes('website'))) && (
                      <motion.div
                    ...
                    {/* Desktop App */}
                    {(project.platforms.some(p => p.toLowerCase().includes('admin') || p.toLowerCase().includes('dashboard'))) && (
                      <motion.div
