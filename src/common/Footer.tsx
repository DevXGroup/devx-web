          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1 xl:col-span-1 flex flex-col">
              ...
              <div className="flex space-x-4 mt-auto">
                <Link
                  href="#"
                  className="text-muted-foreground hover:text-primary transition-colors p-2 hover:bg-gray-700"
                  aria-label="YouTube"
                >
            ...
            <div className="sm:hidden grid grid-cols-2 gap-4 col-span-1">
              ...
              <div className="min-w-0">
                ...
                <div className="space-y-2">
                  <Link href="/services" className="block text-sm text-muted-foreground hover:text-primary hover:bg-gray-700 transition-colors truncate">
                    Custom Software
                  </Link>
                  <Link href="/services" className="block text-sm text-muted-foreground hover:text-primary hover:bg-gray-700 transition-colors truncate">
                    AI & ML
              ...
              <div className="min-w-0">
                ...
                <div className="space-y-2">
                  <Link href="/about" className="block text-sm text-muted-foreground hover:text-primary hover:bg-gray-700 transition-colors truncate">
                    About Us
                  </Link>
                  <Link href="/portfolio" className="block text-sm text-muted-foreground hover:text-primary hover:bg-gray-700 transition-colors truncate">
                    Portfolio
                  </Link>
                  <Link href="/pricing" className="block text-sm text-muted-foreground hover:text-primary hover:bg-gray-700 transition-colors truncate">
                    Pricing
                  </Link>
                  <Link href="/contact" className="block text-sm text-muted-foreground hover:text-primary hover:bg-gray-700 transition-colors truncate">
                    Contact
                  </Link>
                  <Link href="https://calendly.com/a-sheikhizadeh/devx-group-llc-representative" className="block text-sm text-muted-foreground hover:text-primary hover:bg-gray-700 transition-colors truncate">
                    Schedule Call
                  </Link>
                </div>
              </div>
          ...
          <div className="mt-8 lg:mt-12 pt-6 lg:pt-8 border-t border-border">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 lg:gap-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:flex lg:items-center gap-3 lg:gap-6 text-sm text-muted-foreground">
                ...
                <span className="flex items-center justify-center sm:justify-start gap-2">
                  <svg className="w-4 h-4 text-muted-foreground" viewBox="0 0 1920 1920" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 1694.235h1920V226H0v1468.235ZM112.941 376.664V338.94H1807.06v37.723L960 1111.233l-847.059-734.57ZM1807.06 526.198v950.513l-351.134-438.89-88.32 70.475 378.353 472.998H174.042l378.353-472.998-88.32-70.475-351.134 438.89V526.198L960 1260.768l847.059-734.57Z" fillRule="evenodd" fill="currentColor"/>
                  </svg>
              ...
              <div className="flex flex-col sm:flex-row gap-3 lg:gap-4 text-sm border-t sm:border-t-0 pt-4 sm:pt-0 justify-center lg:justify-start">
                <Link href="/privacy" className="text-muted-foreground hover:text-primary transition-colors text-center lg:text-left">
                  Privacy Policy
                </Link>
                <Link href="/terms" className="text-muted-foreground hover:text-primary transition-colors text-center lg:text-left">
                  Terms of Service
                </Link>
                <Link href="/sitemap.xml" className="text-muted-foreground hover:text-primary transition-colors text-center lg:text-left">
                  Sitemap
                </Link>
              </div>
            </div>
