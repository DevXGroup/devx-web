...
export const portfolioProjects: ProjectData[] = [
  {
    ...
    businessImpact:
      'Helped businesses cut customer service costs by 60% while responding to customers 75% faster',
    completionYear: '2024',
